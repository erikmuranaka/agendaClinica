...
from .models import fornecedor as dadosdb
from .forms import fornecedorForm as form
...
def listar(request):
    ...
    return render(request, 'listar_fornecedor.html', {'list_dados': obj_dados, 'ativo': ativo_filter})
...
def cadastrar(request):
    ...
    if request.method == 'POST':
        ...
        if formDados.is_valid():
            ...
            fornecedor_dados = formDados.save(commit=False)
            fornecedor_dados.ativo = True
            fornecedor_dados.save()
    ...
    return render(request, 'cadastrar_fornecedor.html', {'form': formDados})
...
def alterar(request, id):
    ...
    return render(request, 'alterar_fornecedor.html', {'form': formDados})
